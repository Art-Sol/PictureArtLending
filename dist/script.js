...
/* harmony import */ var _modules_showMoreElements__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/showMoreElements */ "./src/js/modules/showMoreElements.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider', '.main-slider-item', '', '', 1, true, 'vertically');
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider', '.feedback-slider-item', '.main-prev-btn', '.main-next-btn', 1, true, 'horizontally');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_showMoreElements__WEBPACK_IMPORTED_MODULE_3__["default"])('.button-styles', '#styles .row', 'http://localhost:3000/styles');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_4__["default"])('.calcForm');
  ...
  Object(_modules_drop__WEBPACK_IMPORTED_MODULE_10__["default"])('[name="upload"]');
});
...
function burger(menuBtnSelector, menuBodySelector) {
  var btn = document.querySelector(menuBtnSelector),
...
/* harmony import */ var _services_getData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/getData */ "./src/js/modules/services/getData.js");
/* harmony import */ var _services_priceOutput__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./services/priceOutput */ "./src/js/modules/services/priceOutput.js");
...
function calc(formSelector) {
  ...
  function getPrice() {
    if (!selectSize.value || !selectMaterial.value) {
      Object(_services_priceOutput__WEBPACK_IMPORTED_MODULE_5__["default"])(priceElem, 'notEnough');
    } else {
      Object(_services_getData__WEBPACK_IMPORTED_MODULE_4__["default"])('http://localhost:3000/prices').then(function (res) {
        var sizePrice = res.size[selectSize.value],
        ...
        Object(_services_priceOutput__WEBPACK_IMPORTED_MODULE_5__["default"])(priceElem, 'success', sum);
      }).catch(function (err) {
        Object(_services_priceOutput__WEBPACK_IMPORTED_MODULE_5__["default"])(priceElem, 'error');
        console.log(err);
      }).finally();
    }
  }
...
/* harmony import */ var _services_postData_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./services/postData.js */ "./src/js/modules/services/postData.js");
...
function drop(inputSelector) {
  var inputsUpload = document.querySelectorAll(inputSelector);
  ['dragenter', 'dragover', 'dragleave', 'drop'].forEach(function (eventType) {
    inputsUpload.forEach(function (input) {
  ...
  inputsUpload.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      var dot = arrFileName[0].length > 6 ? '...&nbsp&nbsp.' : '.';
      fileName = "".concat(arrFileName[0].slice(0, 6)).concat(dot).concat(arrFileName[1]);
      ...
      if (input.classList.contains('_autoloading')) {
        ...
        Object(_services_postData_js__WEBPACK_IMPORTED_MODULE_8__["default"])('assets/server.php', formData).then(function (res) {
          console.log(res);
          setTimeout(function () {
...
function filter() {
  ...
  function noItems(menuItemName) {
    if (!Array.from(items).find(function (item) {
      return item.classList.contains(menuItemName);
    })) {
  ...
  menu.addEventListener('click', function (e) {
    if (e.target && e.target.tagName === 'LI') {
      var menuItemName = e.target.className.replace('active', '').trim();
      menuActiveStyle(e);
...
/* harmony import */ var _services_postData__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./services/postData */ "./src/js/modules/services/postData.js");
/* harmony import */ var _services_closeModal__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./services/closeModal */ "./src/js/modules/services/closeModal.js");
/* harmony import */ var _services_inputPhoneValid__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./services/inputPhoneValid */ "./src/js/modules/services/inputPhoneValid.js");
/* harmony import */ var _services_inputTextValid__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./services/inputTextValid */ "./src/js/modules/services/inputTextValid.js");
/* harmony import */ var _services_priceOutput__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./services/priceOutput */ "./src/js/modules/services/priceOutput.js");
...
var forms = function forms() {
  ...
  Object(_services_inputPhoneValid__WEBPACK_IMPORTED_MODULE_14__["default"])('[name = phone]');
  Object(_services_inputTextValid__WEBPACK_IMPORTED_MODULE_15__["default"])('[name = name]');
  Object(_services_inputTextValid__WEBPACK_IMPORTED_MODULE_15__["default"])('[name = message]');
  uploadInputs.forEach(function (uploadImput) {
    uploadImput.addEventListener('input', function () {
      var fileName = uploadImput.files[0].name;
      var arrFileName = fileName.split('.');
      var dot = arrFileName[0].length > 6 ? '...&nbsp&nbsp.' : '.';
      fileName = "".concat(arrFileName[0].slice(0, 6)).concat(dot).concat(arrFileName[1]);
  ...
  function messageStatus(form, messageObj) {
    ...
    if (Array.from(form.parentElement.children).find(function (item) {
      return item.classList.contains('messageStatus');
    })) {
      messageElement = Array.from(form.parentElement.children).find(function (item) {
        return item.classList.contains('messageStatus');
      });
    } else {
    ...
    messageElement.innerHTML = "\n\t\t\t\t\t\t\t\t\t\t\t\t<img src=\"".concat(messageObj.img, "\"></img>\n\t\t\t\t\t\t\t\t\t\t\t\t<p>").concat(messageObj.message, "</p>\n\t\t\t\t\t\t\t\t\t\t\t");
    messageElement.style.color = "".concat(messageObj.color);
  ...
  function clearInputsAndData(form) {
    var messageStatus = document.querySelectorAll('.messageStatus'),
    ...
    uploadInputs.forEach(function (item) {
      item.previousElementSibling.textContent = 'Файл не выбран';
    });
    Object(_services_priceOutput__WEBPACK_IMPORTED_MODULE_16__["default"])(calcPriceElem, 'clear');
    allModals.forEach(function (modal) {
      return Object(_services_closeModal__WEBPACK_IMPORTED_MODULE_13__["default"])(modal);
    });
    form.classList.remove('animated', 'fadeOut');
    form.style.display = 'block';
    messageStatus.forEach(function (item) {
      return item.remove();
    });
  }
  ...
  function initFormSubmit(form) {
    form.addEventListener('submit', function (e) {
      ...
      if (form.contains(calcPriceElem)) {
        var price = calcPriceElem.textContent.replace(/\D/g, '');
        formData.set('price', price);
      }

      var api = form.closest('.popup-design') || form.classList.contains('calcForm') ? path.designer : path.question;
      Object(_services_postData__WEBPACK_IMPORTED_MODULE_12__["default"])(api, formData).then(function (data) {
        console.log(data);
...
/* harmony import */ var _services_closeModal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/closeModal */ "./src/js/modules/services/closeModal.js");
/* harmony import */ var _services_openModal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/openModal */ "./src/js/modules/services/openModal.js");
...
function modals(state) {
  function bindModal(triggerSelector, windowSelector, closeSelector) {
    ...
    var hideTrigger = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : false;
    var openByScroll = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : false;
    var triggers = document.querySelectorAll(triggerSelector),
    ...
    triggers.forEach(function (trigger) {
      trigger.addEventListener('click', function (e) {
        ...
        if (propsValidation.length > 0) {
          ...
          if (checkValidation) {
            allModals.forEach(function (modal) {
              return Object(_services_closeModal__WEBPACK_IMPORTED_MODULE_3__["default"])(modal);
            });
            Object(_services_openModal__WEBPACK_IMPORTED_MODULE_4__["default"])(windowOfModal);
          } else {
    ...
    closeBtn.addEventListener('click', function () {
      ...
      Object(_services_closeModal__WEBPACK_IMPORTED_MODULE_3__["default"])(windowOfModal);
    });
    windowOfModal.addEventListener('click', function (e) {
    ...
    function scrollOpenModal() {
      var totalHeight = Math.max(document.body.scrollHeight, document.documentElement.scrollHeight, document.body.offsetHeight, document.documentElement.offsetHeight, document.body.clientHeight, document.documentElement.clientHeight);
      var userScroll = document.documentElement.scrollTop + document.documentElement.clientHeight;

      if (totalHeight === userScroll) {
        if (hideTrigger && Array.from(triggers).every(function (item) {
  ...
  function showModalByTime(windowSelector, time) {
    var windowOfModal = document.querySelector(windowSelector),
        allModals = document.querySelectorAll('[data-modal]');
    setTimeout(function () {
      var openMode = true;
      allModals.forEach(function (modal) {
...
function pictureSize(blockSelector) {
  ...
  function showPicture(block) {
    var texts = block.querySelectorAll('p:not(.sizes-hit)'),
  ...
  blocks.forEach(function (block) {
    block.addEventListener('mouseover', function () {
      return showPicture(block);
    });
    block.addEventListener('mouseout', function () {
      return hidePicture(block);
    });
  });
}
...
function scrolling(triggerSelector) {
  ...
  window.addEventListener('scroll', function () {
    if (document.documentElement.scrollTop > 1650) {
      ...
      trigger.classList.remove('fadeIn');
...
/***/ "./src/js/modules/services/getData.js":
/*!********************************************!*\
  !*** ./src/js/modules/services/getData.js ***!
  \********************************************/
/*! exports provided: default */
...
/***/ "./src/js/modules/services/inputPhoneValid.js":
/*!****************************************************!*\
  !*** ./src/js/modules/services/inputPhoneValid.js ***!
  \****************************************************/
/*! exports provided: default */
...
function inputPhoneValid(selector) {
  ...
  function getInputNumberValue(e) {
    var inputValueFull = e.target.value,
  ...
  function initPhoneInput(e) {
    ...
    var resultInputValue;

    if (input.value.length != input.selectionStart) {
      var range = input.selectionStart - 1;
...
/* harmony default export */ __webpack_exports__["default"] = (inputPhoneValid);

/***/ }),

/***/ "./src/js/modules/services/inputTextValid.js":
/*!***************************************************!*\
  !*** ./src/js/modules/services/inputTextValid.js ***!
  \***************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (inputTextValid);
...
/***/ "./src/js/modules/services/priceOutput.js":
/*!************************************************!*\
  !*** ./src/js/modules/services/priceOutput.js ***!
  \************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (priceOutput);

/***/ }),

/***/ "./src/js/modules/showMoreElements.js":
/*!********************************************!*\
  !*** ./src/js/modules/showMoreElements.js ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony import */ var _services_getData__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./services/getData */ "./src/js/modules/services/getData.js");
...
function showMoreElements(trigger, wrapper, url) {
  ...
  function createElem(arrayOfObjects) {
    ...
    try {
      for (var _iterator = arrayOfObjects[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var objDataOfElement = _step.value;
        var element = document.createElement('div');
        element.classList.add('col-sm-3', 'col-sm-offset-0', 'col-xs-10', 'col-xs-offset-1', 'animated', 'fadeInUp', 'newDownloadedElement');
        element.style.display = 'none';
        element.innerHTML = "\n\t\t\t\t\t\t<div class=\"styles-block\">\n\t\t\t\t\t\t\t<img src=".concat(objDataOfElement.src, " alt=\"style\">\n\t\t\t\t\t\t\t<h4>").concat(objDataOfElement.title, "</h4>\n\t\t\t\t\t\t\t<a href=").concat(objDataOfElement.link, ">\u041F\u043E\u0434\u0440\u043E\u0431\u043D\u0435\u0435</a>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t");
    ...
    var newElements = document.querySelectorAll('.newDownloadedElement');
  ...
  function initShowElements(e) {
    ...
    e.preventDefault();
    Object(_services_getData__WEBPACK_IMPORTED_MODULE_12__["default"])(url).then(function (response) {
      createElem(response);
...
/* harmony default export */ __webpack_exports__["default"] = (showMoreElements);
...
function slider(sliderBodySelector, slidesSelector, prevBtnSelector, nextBtnSelector) {
  var showFirstSlider = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 1;
  var loop = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : false;
  var direction = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 'horizontally';
  var slides = document.querySelectorAll(slidesSelector),
      sliderBody = document.querySelector(sliderBodySelector);
  var slideIndex = showFirstSlider - 1,
      sliderIntervalId;
  ...
  if (loop) {
    ...
    slides[0].parentElement.addEventListener('mouseenter', function () {
      return clearTimeout(sliderIntervalId);
    });
